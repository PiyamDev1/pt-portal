...
type EditModalProps = {
  open: boolean
  onClose: () => void
  editFormData: PakEditFormData
  setEditFormData: React.Dispatch<React.SetStateAction<PakEditFormData>>
  deleteAuthCode: string
  setDeleteAuthCode: React.Dispatch<React.SetStateAction<string>>
  onSubmit: () => void
  onDelete: () => void
}
      ...
      >
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="edit-cnic" className="text-[10px] uppercase font-bold text-slate-400">
                CNIC
              </label>
              <input
                id="edit-cnic"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFormData({ ...editFormData, applicantEmail: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFormData({ ...editFormData, applicantPhone: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setEditFormData({ ...editFormData, trackingNumber: e.target.value.toUpperCase() })
                }
              />
            </div>
            <div>
              <label
                htmlFor="edit-old-passport"
                className="text-[10px] uppercase font-bold text-slate-400"
              >
                Old Passport #
              </label>
              <input
                id="edit-old-passport"
                className="w-full p-2 border rounded text-sm font-mono"
                value={editFormData.oldPassportNumber || ''}
                onChange={(e) =>
                  setEditFormData({
                    ...editFormData,
                    oldPassportNumber: e.target.value.toUpperCase(),
                  })
                }
              />
            </div>
            <div className="col-span-2">
              ...
              <input
                ...
                className="w-full p-2 border rounded text-sm"
                value={editFormData.familyHeadEmail || ''}
                onChange={(e) =>
                  setEditFormData({ ...editFormData, familyHeadEmail: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <select
                id="edit-speed"
                className="w-full p-2 border rounded text-sm"
                value={editFormData.speed || 'Normal'}
            ...
            <div className="bg-red-50 p-4 rounded-xl border border-red-100">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="button"
                  onClick={onDelete}
                  className="bg-white text-red-600 border border-red-200 px-4 py-2 rounded font-bold hover:bg-red-600 hover:text-white transition"
                >
                  Delete
                </button>
              </div>
