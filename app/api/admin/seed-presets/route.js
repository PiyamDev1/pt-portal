...
const PRESETS = [
  {
    ...
    types: [
      ...
      {
        name: 'Multiple Entry 1yr',
        validity: '12 Months',
        cost: 80,
        price: 125,
        nationalities: [...EU_COUNTRIES, 'United States', 'Canada', 'Australia'],
      },
      {
        name: 'Umrah - Single Entry (Pakistani)',
        validity: '30 Days',
        cost: 155,
        price: 235,
      ...
      {
        name: 'Umrah - Single Entry (Indian/Bangladeshi)',
        validity: '30 Days',
        cost: 165,
        price: 245,
        nationalities: ['India', 'Bangladesh'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    types: [
      {
        name: 'Schengen Visa (Application Fill)',
        validity: 'N/A',
        cost: 0,
        price: 65,
        nationalities: ['Any'],
  ...
  },
  {
    ...
    types: [
      ...
      {
        name: 'Tourist (Travel Document)',
        validity: '30 Days',
        cost: 175,
        price: 220,
        nationalities: ['Travel Document'],
      },
    ],
  },
  {
    ...
    types: [
      {
        name: 'Red - Single Entry (EU)',
        validity: '60 Days',
        cost: 105,
        price: 135,
        nationalities: EU_COUNTRIES,
      },
      {
        name: 'Green - Single Entry (Pak/Ind/Ban)',
        validity: '60 Days',
        cost: 105,
        price: 135,
        nationalities: ['Pakistan', 'Bangladesh', 'India'],
      },
    ],
  },
  {
    ...
    types: [
      {
        ...
        cost: 55,
        price: 85,
        nationalities: ['Pakistan', 'India', 'Bangladesh'],
      },
    ],
  },
  {
    ...
    types: [
      {
        ...
        cost: 25,
        price: 65,
        nationalities: [...EU_COUNTRIES, 'Australia'],
      },
    ],
  },
  {
  ...
  try {
    ...
    for (const group of PRESETS) {
      ...
      for (const type of group.types) {
        const { error } = await supabase.from('visa_types').upsert(
          {
    ...
    return apiOk({ syncedPresetCount: logs.length, logs })
  } catch (error) {
    return apiError(toErrorMessage(error, 'Failed to seed presets'), 500)
  }
}
