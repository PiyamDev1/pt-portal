...
export default async function TimeclockTeamPage() {
  ...
  if (!hasManagerTimeclockAccess(roleName, reportCount) && !hasMaintenanceTimeclockAccess(roleName)) {
      ...
      <div className="min-h-screen bg-slate-50 flex flex-col">
        ...
        <main className="max-w-6xl mx-auto p-6 w-full flex-grow space-y-6">
          <div>
            ...
            <p className="text-slate-500">Review timeclock punches for your reports, or across the site if you have maintenance access.</p>
          </div>
          <TimeclockTeamClient />
        </main>
      </div>
