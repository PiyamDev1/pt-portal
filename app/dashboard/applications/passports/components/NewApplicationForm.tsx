    ...
    <div className="bg-green-50 p-4 rounded-xl border border-green-100 shadow-md animate-fade-in-down">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-5">
          <h4 className="text-xs font-black uppercase text-slate-400 tracking-widest border-b border-slate-100 pb-2">
          ...
          <div>
            ...
            {errors.applicantName && (
              <p id="applicantName-error" className="text-red-600 text-xs mt-1" role="alert">
                {errors.applicantName}
              </p>
            )}
          </div>
          <div>
            ...
            {errors.applicantCnic && (
              <p id="applicantCnic-error" className="text-red-600 text-xs mt-1" role="alert">
                {errors.applicantCnic}
              </p>
            )}
          </div>
          <div>
            ...
            {errors.applicantEmail && (
              <p id="applicantEmail-error" className="text-red-600 text-xs mt-1" role="alert">
                {errors.applicantEmail}
              </p>
            )}
          </div>
          <div>
            ...
            {errors.applicantPhone && (
              <p id="applicantPhone-error" className="text-red-600 text-xs mt-1" role="alert">
                {errors.applicantPhone}
              </p>
            )}
          </div>
          <div>
            ...
            {errors.familyHeadEmail && (
              <p id="familyHeadEmail-error" className="text-red-600 text-xs mt-1" role="alert">
                {errors.familyHeadEmail}
              </p>
            )}
          </div>
          ...
          <div className="flex items-center gap-3 bg-green-50 p-3 rounded-lg border border-green-100 mt-2">
            <input
              ...
              id="fp_check"
            />
            <label htmlFor="fp_check" className="text-sm font-bold text-green-800 cursor-pointer">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <select
              name="speed"
              onChange={onChange}
              className="p-2 bg-white border border-green-100 rounded-lg text-sm font-bold text-slate-700"
              value={formData.speed}
            >
              {metadata.speeds.map((speed) => (
          ...
          <div>
            <input
              ...
              className="w-full p-2 bg-white border border-green-100 rounded-lg text-sm font-mono uppercase font-bold text-slate-700"
            />
            {errors.trackingNumber && (
              <p className="text-red-600 text-xs mt-1">{errors.trackingNumber}</p>
            )}
          </div>
        </div>
      </div>
      <button
        ...
        className="w-full mt-6 bg-green-600 text-white py-3 rounded-lg font-bold hover:bg-green-700 transition shadow"
      >
