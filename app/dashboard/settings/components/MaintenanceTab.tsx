...
export function MaintenanceTab({ canRunHighRiskActions }: { canRunHighRiskActions: boolean }) {
      ...
      <div className="border-t pt-6 space-y-4">
        ...
        {canRunHighRiskActions ? (
          ...
          <div className="rounded-lg border border-amber-200 bg-amber-50 p-4 text-sm text-amber-900">
            Database migrations and financial backfills require an Admin or Super Admin. Routine
            health checks, synchronization, and staff-detail corrections remain available to
            Maintenance Admin.
          </div>
        )}
