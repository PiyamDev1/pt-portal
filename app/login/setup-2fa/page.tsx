...
export default function Setup2FAPage() {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Replace the history so back button does not return to the enrollment step.
              ...
              <details className="text-left">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-3 text-left">
                  <p className="text-xs text-blue-900 font-medium mb-3">
                    If you&apos;re setting up 2FA on the same device:
                  </p>
                  ...
                  <p className="text-xs text-blue-700 mt-3 italic">
                    After adding the key to your authenticator app, return here and enter the
