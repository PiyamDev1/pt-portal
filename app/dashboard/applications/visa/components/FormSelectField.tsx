...
export function FormSelectField({
  ...
  const baseClasses =
    'w-full mt-3 p-2 border rounded text-sm focus:border-purple-500 focus:ring-1 focus:ring-purple-500 disabled:opacity-50'
  ...
  return (
    <div>
      <label
        htmlFor={fieldId}
        className={`text-xs font-medium ${variant === 'purple' ? 'text-purple-700' : 'text-slate-700'} flex items-center gap-1`}
      >
        {icon}
        {label}
      </label>
