...
> **Point-in-time completion note.** Verify current timeclock UI, exports, calculations, access rules, and Frappe attendance synchronization before operational use.
