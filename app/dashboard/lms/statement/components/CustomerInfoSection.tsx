/**
 * Module: app/dashboard/lms/statement/components/CustomerInfoSection.tsx
 * Dashboard module for lms/statement/components/CustomerInfoSection.tsx.
 */
    ...
    <>
      ...
      <div className="border-b-2 border-slate-900 pb-4 flex items-start justify-between gap-6 print:gap-3 print:pb-2">
        ...
        <div className="flex-1 text-right print:text-right">
          <h2 className="text-xl font-bold text-slate-900 print:text-base print:mb-0">
            Piyam Travel
          </h2>
          <p className="text-slate-600 print:text-xs print:mb-0">
            290A Dunstable Road, LU4 8JN, Luton
          </p>
      ...
      <div className="grid grid-cols-2 gap-6 print:gap-8 print:text-xs">
        <div>
          <h3 className="text-xs font-bold text-slate-500 uppercase mb-2 print:text-[10px] print:mb-1">
            Customer Details
          </h3>
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-600 print:text-xs print:mb-0">
              {account.address || 'N/A'}
            </p>
          </div>
        </div>
        <div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm print:text-xs print:mb-0">
              ...
              <span className="font-bold">Full Account History</span>
            </p>
            <p className="text-sm print:text-xs print:mb-0">
              <span className="text-slate-600">Status:</span>{' '}
              <span className="font-bold text-blue-600">{account.status?.toUpperCase()}</span>
            </p>
            <p className="text-sm print:text-xs print:mb-0">
