  ...
  return (
    <div className="space-y-7">
      <section className="relative overflow-hidden rounded-[1.9rem] bg-gradient-to-br from-[#4b0f16] via-[#7b1926] to-[#292b30] px-6 py-7 text-white shadow-xl shadow-red-950/20 sm:px-8 sm:py-8">
        ...
        <div className="relative flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-6 text-red-50/80">
              Hi {firstName}. This view reflects completed records attributed to you. It does not
              create a score or compare you with another employee.
            </p>
          </div>
        ...
        <nav className="relative mt-6 flex flex-wrap gap-2" aria-label="Performance sections">
          {[
            ['#activity', 'Activity'],
            ['#attendance', 'Attendance'],
            ['#commissions', 'Earnings & commission'],
          ].map(([href, label]) => (
            <a
              key={href}
              href={href}
              className="rounded-full border border-white/15 bg-white/10 px-3.5 py-2 text-xs font-black text-white transition hover:bg-white/20"
            >
              {label}
            </a>
          ))}
        ...
        <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
              Counts follow the current source record, so corrected, reversed, deleted and archived
              work is not retained as performance.
            </p>
          </div>
          {data.activityReady && (
              ...
              <article className="rounded-[1.6rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <h3 className="mt-1 text-xl font-black text-slate-950">Recorded work trend</h3>
                  </div>
      ...
      <section id="commissions" className="scroll-mt-24 space-y-5">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 max-w-2xl text-sm leading-6 text-slate-500">
              ...
              the work activity attributed to you above.
            </p>
          </div>
        </div>
