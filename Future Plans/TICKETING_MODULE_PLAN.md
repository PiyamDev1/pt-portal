...
6. Return Date (optional) → 7. Deadline → 8. Booking Type → 9. Sale Cost → 10. Pax Count  
11. Payment Status → 12. Save Button
...
*Note: Void rows appear with strikethrough text and red background badge*
