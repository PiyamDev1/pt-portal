...
export const DASHBOARD_MODULES: DashboardModule[] = [
  ...
  },
  {
    id: 'pos',
    title: 'POS',
    desc: 'Daily cash, payments and quick entry',
    href: '/dashboard/pos',
    group: 'operations',
    accent: 'from-amber-600 to-[#8b1e2d] text-white',
  ...
  },
  {
    ...
    desc: 'Employee agreements and calculation health',
  ...
  },
  {
    ...
    group: 'admin',
    allowedRoles: ['Admin', 'Master Admin', 'Super Admin', 'Maintenance Admin'],
