...
import type { GbHistoryLog } from './types'
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {isLoading ? (
            ...
            <div
              className="text-center py-8 text-slate-400 flex flex-col items-center gap-2"
              role="status"
              aria-live="polite"
            >
                    ...
                    <div className="flex justify-between items-start mb-2">
                      <div>
                        ...
                        <div className="font-bold text-slate-800 text-sm mt-0.5">
                          {log.old_status || 'New'} <span className="text-slate-400 mx-1">→</span>{' '}
                          <span className="text-blue-600">{log.new_status}</span>
                        </div>
                      </div>
