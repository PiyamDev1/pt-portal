...
HISTORICAL HANDOFF SNAPSHOT — verify every environment, route, migration, and Frappe deployment detail against docs/guides/FRAPPE_HRMS_SETUP.md and current source before reuse.
Date: 2026-04-18
